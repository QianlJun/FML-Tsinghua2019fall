...
# DEFAULT_HISTORY_SAVEFILE = "logs/model_double_duel_dqn_map1_6.csv"
# DEFAULT_MODEL_SAVEFILE = "save/model_double_duel_dqn_map1_6.ckpt"  # model2: tau=0.001
# DEFAULT_HISTORY_SAVEFILE = "logs/model_double_duel_dqn_mapdfc_6_1.csv"  #
# DEFAULT_MODEL_SAVEFILE = "save/model_double_duel_dqn_mapdfc_6_1.ckpt"  # model: uodate_freq=1, frame_repeat=12
# DEFAULT_HISTORY_SAVEFILE = "logs/model_double_duel_dqn_mapdfc_6_2.csv"  #
# DEFAULT_MODEL_SAVEFILE = "save/model_double_duel_dqn_mapdfc_6_2.ckpt"  # model: uodate_freq=1, frame_repeat=12
# DEFAULT_HISTORY_SAVEFILE = "logs/model_double_duel_dqn_map2_6_2.csv"  #
# DEFAULT_MODEL_SAVEFILE = "save/model_double_duel_dqn_map2_6_2.ckpt"  # model: uodate_freq=1, frame_repeat=12,100epoch
# DEFAULT_HISTORY_SAVEFILE = "logs/model_double_duel_dqn_map2_6_RGB.csv"  #
# DEFAULT_MODEL_SAVEFILE = "save/model_double_duel_dqn_map2_6_RGB.ckpt"  # model: uodate_freq=1, frame_repeat=12,RGB,m20000,epoch
DEFAULT_HISTORY_SAVEFILE = "logs/model_double_duel_dqn_map2_6_RGB_100.csv"  #
DEFAULT_MODEL_SAVEFILE = "save/model_double_duel_dqn_map2_6_RGB.ckpt-250"  # model: uodate_freq=1, frame_repeat=12,RGB,m20000,epoch+100,lr0.0001,eps0.3
        ...
        for epoch in range(epochs):
            ...
            for learning_step in trange(learning_steps_per_epoch, leave=False):
                ...
                if memory.size > batch_size:
                    ...
                    # Double dqn
                    a_max = session.run(eval_QN.best_a, feed_dict={eval_QN.s1_: s2})
                    q_next = session.run(target_QN.q, feed_dict={target_QN.s1_: s2})
                    q2 = q_next[range(batch_size), a_max]
