...
# DEFAULT_MODEL_SAVEFILE = "save/model_double_dqn_2"  # model2: tau=0.001
# DEFAULT_HISTORY_SAVEFILE = "logs/model_double_dqn_2.csv"
# DEFAULT_HISTORY_SAVEFILE = "logs/model_double_dqn_map1_6.csv"
# DEFAULT_MODEL_SAVEFILE = "save/model_double_dqn_map1_6.ckpt"  # model2: tau=0.001
# DEFAULT_HISTORY_SAVEFILE = "logs/model_double_dqn_map2_6.csv"
# DEFAULT_MODEL_SAVEFILE = "save/model_double_dqn_map2_6.ckpt"  # model: GRAY8, frame_repeat4,learn_step:4000, replaymemory20000
# DEFAULT_HISTORY_SAVEFILE = "logs/model_double_dqn_mapdfc_6_1.csv"  #
# DEFAULT_MODEL_SAVEFILE = "save/model_double_dqn_map2_6_1.ckpt"  # model: uodate_freq=1, frame_repeat=12
# DEFAULT_HISTORY_SAVEFILE = "logs/model_double_dqn_map2_6_1.csv"  #
# DEFAULT_MODEL_SAVEFILE = "save/model_double_dqn_map2_6_1.ckpt"  # model: uodate_freq=1, frame_repeat=12,30epoch
DEFAULT_HISTORY_SAVEFILE = "logs/model_double_dqn_map2_6_2.csv"  #
DEFAULT_MODEL_SAVEFILE = "save/model_double_dqn_map2_6_2.ckpt"  # model: uodate_freq=1, frame_repeat=12,100epoch
        ...
        for epoch in range(epochs):
            ...
            for learning_step in trange(learning_steps_per_epoch, leave=False):
                ...
                if memory.size > batch_size:
                    ...
                    # evel_q = session.run(eval_QN.q, feed_dict={eval_QN.s1_: s1})
